...
result: skipped
reason: "Cannot test interactive TTY prompts in automated session"
...
result: skipped
reason: "Cache invalidation verified via code review -- invalidate(KEY_WORKFLOWS) called on create/update/delete"
...
result: skipped
reason: "Shell completions verified via code review -- workflow_id_candidates() function exists and follows established pattern"
